    ...
    <div class="max-w-2xl bg-gray-50 py-10 px-5 m-auto w-full mt-10">
        ...
        <form wire:submit.prevent="save">
            ...
            <div>
                ...
                <x-jet-input wire:model="title" id="title" class="block mt-1 w-full" type="text" name="title" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-jet-input wire:model="nature" id="nature" class="block mt-1 w-full" name="nature" required />
            </div>

            <div class="mt-4">
                <x-jet-label for="keyword-search" value="Raktažodžiai" />
                <x-jet-input wire:keydown.enter="addKeyword" wire:model="inputKeyword" id="keyword-search" class="block mt-1 w-full" name="keyword-search" required />
            </div>
